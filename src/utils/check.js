...
class Check {
    ...
    #compileCoreAdminOperationSchema() {
        const schema = {
            ...
            address: {type: 'buffer', length: config.addressLength, required: true}, // invoker adddress (admin)
            cao: {
                strict: true,
                type: 'object',
                props: {
    ...
    #compileBalanceInitializationSchema() {
        const schema = {
            ...
            address: { type: 'buffer', length: config.addressLength, required: true },
            bio: {
                strict: true,
                type: 'object',
                props: {
                    tx: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx hash
                    txv: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx validity
                    ia: { type: 'buffer', length: config.addressLength, required: true }, // selected address to specific operation.
        ...
        const schema = {
            ...
            aco: {
                ...
                props: {
                    tx: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx hash
                    txv: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx validity
                    ia: { type: 'buffer', length: config.addressLength, required: true }, // incoming address - selected address for specific operation
                    in: { type: 'buffer', length: NONCE_BYTE_LENGTH, required: true }, // nonce
                    is: { type: 'buffer', length: SIGNATURE_BYTE_LENGTH, required: true }, // signature
                }
            }
        ...
        const schema = {
            ...
            rao: {
                ...
                props: {
                    ...
                    in: { type: 'buffer', length: NONCE_BYTE_LENGTH, required: true }, // nonce of the invoker
                    is: { type: 'buffer', length: SIGNATURE_BYTE_LENGTH, required: true }, // signature
                    va: { type: 'buffer', length: config.addressLength, optional: true },
    ...
    #compileTransactionOperationSchema() {
        const schema = {
            ...
            address: {type: 'buffer', length: config.addressLength, required: true}, // invoker address
            txo: {
                strict: true,
                type: 'object',
                props: {
                    ...
                    va: { type: 'buffer', length: config.addressLength, optional: true }, //validator address
        ...
        const schema = {
            ...
            tro: {
                ...
                props: {
                    tx: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx hash
                    txv: { type: 'buffer', length: HASH_BYTE_LENGTH, required: true }, // tx validity
                    to: { type: 'buffer', length: config.addressLength, required: true }, // recipient address
