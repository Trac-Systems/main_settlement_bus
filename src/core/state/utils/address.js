 ...
 * @param {string} prefix - The HRP of the bech32m address.
 * @returns {boolean} True if the address is valid, false otherwise.
 */
export function isAddressValid(address, prefix) {
    const addressLength = prefix.length + 1 + TRAC_PUBLIC_KEY_SIZE * 2
