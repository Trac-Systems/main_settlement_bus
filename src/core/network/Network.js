        ...
        if (!this.#swarm) {
            ...
            this.#swarm.on('connection', async (connection) => {
                ...
                try {
                    ...
                    // MAYHEM PATCH: Pear v3 can deliver a late swarm connection while
                    // shutdown is already closing the Corestore. Do not replicate a
                    // connection after close has begun; store.replicate would otherwise
                    // throw "Corestore is closed" and abort the runner.
