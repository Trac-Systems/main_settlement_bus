...
class V1BroadcastTransactionOperationHandler extends V1BaseOperationHandler {
    ...
    async dispatchTransaction(decodedTransaction) {
        ...
        try {
            ...
            if (error instanceof PendingCommitAlreadyExistsError) {
                throw new V1TxAlreadyPendingError(error.message, false); // TODO: consider if false/true
            }
        ...
        try {
            ...
            let err = error;
            if (error instanceof TransactionPoolFullError) {
                err = new V1NodeOverloadedError(error.message, false); // TODO: consider if false/true
                ...
                err = new V1UnexpectedError(`Internal enqueue validation failed: ${error.message}`, true); // TODO: consider if false/true
            }
    ...
    //TODO: Move responsability to new class (next 4 functions)
