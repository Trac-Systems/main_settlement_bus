...
class ResultCodePolicy {
    static senderAction = Object.freeze({
        UNDEFINED: 'UNDEFINED',
        SUCCESS: 'SUCCESS',
        ROTATE: 'ROTATE',
        NO_ROTATE: 'NO_ROTATE',
    ...
    static #successCodes = new Set([
        ResultCode.OK,
    ]);

    static #rotateCodes = new Set([
    ...
    static #noRotateCodes = new Set([
        ResultCode.TX_ALREADY_PENDING,
    ]);

    static resolveValidatorAction(resultCode) {
        if (this.#successCodes.has(resultCode)) return this.senderAction.SUCCESS;
        if (this.#rotateCodes.has(resultCode)) return this.senderAction.ROTATE;
        if (this.#noRotateCodes.has(resultCode)) return this.senderAction.NO_ROTATE;
        return this.senderAction.UNDEFINED
    }
}

export default ResultCodePolicy;
