...
import b4a from 'b4a';
import { addressToBuffer, bufferToAddress } from '../../src/core/state/utils/address.js';
...
const preTxfields = ['op', 'tx', 'ia', 'iw', 'in', 'ch', 'is', 'bs', 'mbs', 'va'];
...
const topFieldsEko = ['type', 'address', 'eko'];
const topFieldsBko = ['type', 'address', 'bko'];
const topFieldsTx = ['type', 'address', 'txo'];

const postTxValueFields = ['tx', 'ia', 'iw', 'in', 'ch', 'is', 'bs', 'mbs', 'vs', 'vn'];
