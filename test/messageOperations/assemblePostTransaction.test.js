...
test('assemblePostTxMessage - ....', async (k) => {
    ...
    const decodedPostTx = safeDecodeApplyOperation(await StateMessageOperations.assemblePostTxMessage(
        nonAdminWallet,
        validatorAddress,
        txHash,
        incomingAddress,
    ...
    k.test(`assemblePostTxMessage - Invalid wallet instance - trac address is to short`, async (k) => {
        ...
        await k.exception(
            async () => await StateMessageOperations.assemblePostTxMessage(
                invalidWallet,
                validatorAddress,
                txHash,
                incomingAddress,
