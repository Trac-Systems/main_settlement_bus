...
test('ConsensusValidationSchema accepts fixed-length proof proposal byte fields', t => {
    ...
    t.is(schema.validateConsensusV1ProofProposal(makeProofProposalPayload(uint64ToBuffer(1))), true);
    t.is(schema.validateConsensusV1ProofProposal(makeProofProposalPayload(uint64ToBuffer(maxUint64))), true);
    t.is(schema.validateConsensusV1ProofProposal(makeProofProposalPayload(uint64ToBuffer(0))), false);
    t.is(schema.validateConsensusV1ProofProposal(
        makeProofProposalPayload(uint64ToBuffer(1), {network_id: uint16ToBuffer(0)})
    ), false);
