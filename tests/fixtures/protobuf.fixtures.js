...
const validAddIndexer = {
    ...
    address: addressToBuffer('trac1jnafrn8xl3c59s4ml6jusufp2vzm6egkyenrcqvd907j8c9v5j2qnx7wvt', TRAC_NETWORK_MSB_MAINNET_PREFIX),
    aco: {
...
const validBalanceInitOperation = {
    ...
    bio: {
        tx: b4a.from('c59f70942febb1de32fcb59febe84560416265d39f39b48fae676592910a98f4', 'hex'),
        txv: b4a.from('eb59a3e756d1c9597e46b33bcea91e262f8f73e94c238bdf70854aa2e8c42608', 'hex'),
        ia: addressToBuffer('trac1xf5sa6k8ykee2dmawpqawj0yjxfx42arx7924eh6k7edf72wrn7seev3pa', TRAC_NETWORK_MSB_MAINNET_PREFIX),
