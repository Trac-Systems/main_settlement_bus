...
export const TRO = {
    valid_partial_transfer: {
        ...
        address: addressToBuffer('trac123z3gfpr2epjwww7ntm3m6ud2fhmq0tvts27p2f5mx3qkecsutlqfys769', TRAC_NETWORK_MSB_MAINNET_PREFIX),
        tro: {
            ...
            to: addressToBuffer('trac1mqktwme8fvklrds4hlhfy6lhmsu9qgfn3c3kuhz7c5zwjt8rc3dqj9tx7h', TRAC_NETWORK_MSB_MAINNET_PREFIX),
    ...
    valid_complete_transfer: {
        ...
        tro: {
            ...
            va: addressToBuffer('trac18qq7h503y3326v6msgvq0jwc0e8jp4t4q53z9p9jvd98arj7mtpqfac04p', TRAC_NETWORK_MSB_MAINNET_PREFIX),
        }
    },
...
export const BDO = {
    valid_partial_bootstrap_deployment: {
        ...
        address: addressToBuffer("trac1cep6jwcf02vmwekr4s0sttraqv736v8nf2gkaejz2203zhf7j7csnf44nm", TRAC_NETWORK_MSB_MAINNET_PREFIX),
        bdo: {
...
export const TXO = {
    valid_complete_transaction_operation: {
        ...
        address: addressToBuffer('trac1c232xtkvyg08zyeurn7l0wrarc4y36fzq5vhcdsgkxe6hdpzuslsm63dw8', TRAC_NETWORK_MSB_MAINNET_PREFIX),
        txo: {
...
export const CAO = {
    validAddAdminOperation: {
        ...
        address: addressToBuffer('trac18qq7h503y3326v6msgvq0jwc0e8jp4t4q53z9p9jvd98arj7mtpqfac04p', TRAC_NETWORK_MSB_MAINNET_PREFIX),
        cao: {
            tx: b4a.from('1bd4f96adeffba9c04943a82993c5b19660c3a5f572620d82a67464f381640e2', 'hex'),
            txv: b4a.from('f24e61cf7941256b080be2133bccb520414c78021215edfcb781622da526c414', 'hex'),
    ...
    validDisableInitializationOperation: {
        ...
        address: addressToBuffer('trac1sq3njyxzd27rsy8zcksgv2jmcsl9dlsmklwwqruhx92dufs3cemqgyrpf7', TRAC_NETWORK_MSB_MAINNET_PREFIX),
        cao: {
...
export const ACO = {
    validAppendWhitelistOperation: {
        ...
        aco: {
            ...
            txv: b4a.from('f24e61cf7941256b080be2133bccb520414c78021215edfcb781622da526c414', 'hex'),
            in: b4a.from('0ad7fe36a35a27ea4df932b800200823a97d4db31bca247f43ad7523b0493645', 'hex'),
            ia: addressToBuffer('trac1xvqvlzx4w2q2pfqrmycew87kq4rv0q0cewxk68ddvddgk2xm09cqvpc4jc', TRAC_NETWORK_MSB_MAINNET_PREFIX),
            is: b4a.from('5b534be7a374148962c271d194c26cf5b1ad705ab218a87709a33fe74f9d1b811772447c939b17b2f803e3da7648f49b666b929fbb20e458ced952f147162c08', 'hex')
        }
    },
...
export const RAO = {
    valid_complete_add_writer: {
        ...
        rao: {
            ...
            in: b4a.from('0ad7fe36a35a27ea4df932b800200823a97d4db31bca247f43ad7523b0493645', 'hex'),
            is: b4a.from('5b534be7a374148962c271d194c26cf5b1ad705ab218a87709a33fe74f9d1b811772447c939b17b2f803e3da7648f49b666b929fbb20e458ced952f147162c08', 'hex'),
            va: addressToBuffer('trac1xvqvlzx4w2q2pfqrmycew87kq4rv0q0cewxk68ddvddgk2xm09cqvpc4jc', TRAC_NETWORK_MSB_MAINNET_PREFIX),
